...
import { X, Calendar, Eye, ArrowRight, CheckCircle, MapPin } from 'lucide-react';
...
const Events = () => {
    ...
    const categories = ['All', 'Society Meeting', 'Cultural Event', 'Sports', 'Workshop', 'General'];
                        ...
                        <div className="max-w-4xl mx-auto w-full px-2 sm:px-4">
                            ...
                            >
                                <h1 className="font-heading text-2xl xs:text-3xl sm:text-5xl md:text-6xl font-black leading-tight mb-3 sm:mb-6 text-white drop-shadow-sm">
                                    Society <span className="text-[#F58220]">Events</span>
                                </h1>
                                <p className="text-sm xs:text-base sm:text-2xl text-gray-100 leading-relaxed mb-6 md:mb-8 font-bold tracking-wide drop-shadow-sm px-1">
                                    Stay informed about upcoming and past events in our society.
                                </p>
                ...
                <div className="container-custom">
                    {filteredImages.length === 0 ? (
                        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-700">
                            ...
                            <p className="text-muted-foreground text-lg">No events match the selected filter.</p>
                            <Button
                                variant="link"
                                ...
                                >
                                    <Card className="overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white dark:bg-gray-800 border-0 h-full flex flex-col">
                                        ...
                                        <CardContent className="p-3 sm:p-4 flex flex-col flex-grow">
                                            ...
                                            {/* Event Date & Location */}
                                            <div className="space-y-1 mt-auto pt-2 border-t border-gray-100 dark:border-gray-700">
                                                <div className="flex items-center text-[10px] sm:text-xs text-gray-500 dark:text-gray-500">
                                                    ...
                                                    <span className="font-medium">{image.eventDate ? formatDate(image.eventDate) : formatDate(image.createdAt)}</span>
                                                </div>
                                                {image.location && (
                                                    <div className="flex items-center text-[10px] sm:text-xs text-gray-500 dark:text-gray-500">
                                                        <MapPin className="h-3 w-3 mr-1.5 text-[#F58220]" />
                            ...
                            <div className="p-6 sm:p-10">
                                ...
                                <div className="space-y-4 pt-8 border-t border-gray-100 dark:border-gray-800">
                                    <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-500">
                                        ...
                                        <span>{selectedImage.eventDate ? formatDate(selectedImage.eventDate) : formatDate(selectedImage.createdAt)}</span>
                                    </div>
                                    ...
                                    {selectedImage.themes && selectedImage.themes.length > 0 && (
                                        <div className="flex flex-wrap gap-2">
                                            {selectedImage.themes.map((theme, idx) => (
                                                <Badge key={idx} className="bg-[#0D4F5C] text-white">{theme}</Badge>
                                            ))}
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#0D4F5C] via-[#0a3d47] to-[#062830] rounded-[3rem] p-10 lg:p-16 text-center shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-6">
                                Want to Stay <span className="text-[#F58220]">Updated?</span>
                            </h2>
                            <p className="text-gray-300 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
                                Contact us to learn more about upcoming society events and how to participate.
                            </p>
